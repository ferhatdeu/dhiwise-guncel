              ...
              <div className="bg-white-A700 flex flex-col items-center justify-center md:px-10 sm:px-5 px-[283px] py-12 rounded shadow-bs w-full">
                <div className="flex flex-col gap-[58px] items-center justify-start w-full">
                  ...
                  <div className="flex flex-col relative w-full">
                    ...
                    <div
                      className="common-pointer bg-deep_orange-300 flex flex-col h-20 items-center justify-start mt-[-17px] mx-auto outline outline-[4px] outline-white-A700 p-[26px] sm:px-5 rounded-[50%] w-20 z-[1]"
                      onClick={() => navigate("/ekycintroductionstepthree")}
                    >
                      <Img
                        className="h-7 w-7"

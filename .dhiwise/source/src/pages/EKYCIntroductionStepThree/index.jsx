                ...
                <div className="flex flex-col gap-[58px] items-center justify-start w-auto">
                  ...
                  <div className="flex flex-col items-start justify-start w-auto sm:w-full">
                    ...
                    >
                      ...
                      <div
                        className="common-pointer bg-white-A700 hover:border hover:border-indigo-50 hover:border-solid hover:cursor-pointer flex flex-1 flex-col items-start justify-center sm:px-5 px-8 py-[25px] rounded hover:shadow-bs1 shadow-bs1 w-full"
                        onClick={() => navigate("/ekycconfirminformation")}
                      >
                        <div className="flex sm:flex-col flex-row gap-6 items-center justify-start w-full">
                          <div className="flex flex-1 flex-row gap-5 items-center justify-start w-full">
